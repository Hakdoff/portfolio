...
function Portfolio() {
    return (
        <>
            <div id="header" className="header wrap">
                <div className="header-container">
                    <div className="nav-left">
                        <a className="header-title" href="./canvas.html">MY PORTFOLIO</a></div>
            ...
            <div id="hero" className="hero wrap">
                <div className="hero-container">
                    <div className="hero-left">
                        <img className="hero-image" src="./FUERTE.jpg" alt=""></img>
                    </div>
                    <div className="hero-right">
                        <p className="intro">Hey There! </p>
                        <p className="name">I'm Erika Fuerte</p>
                        <p className="desc">A passionate Full Stack Software Engineer skilled in building dynamic and responsive web applications, with a focus on delivering high-quality, efficient solutions.</p>

                    </div>
                </div>
            </div>
            <div id="aboutme" className="aboutme wrap">
                <div className="about-container">
                    <div className="about-left">
                        <div className="about-left-padding">
                            <h1 className="about-title">
                                About Me
                            </h1>
                            <p className="about-desc">A passionate entry-level Full Stack Software Engineer with a bachelor’s degree in
                                Information Technology. Currently seeking a position that offers opportunities for
                                growth and career advancement. With hands-on experience as a software engineer, virtual assistant, and social media assistant, I bring strong skills in web and mobile development. Proficient in problem-solving, technical implementation, and effective collaboration in real-world settings, I am eager to take on new challenges, apply my skills to dynamic projects, and further develop my expertise for a successful career in software engineering.
                            </p>
                            <div className="about-buttons-container">
                                <button className="about-button" type="submit">Contact Me</button>
                                <button className="about-button" type="submit">Download CV</button>
                            </div>
                        </div>
                    </div>
                    <div className="about-right">
                        <img className="about-image" src="grad.jpg" alt=""></img>
                    </div>
                </div>
            </div>
            ...
            <div id="project" className="project wrap">
                <div className="project-container">
                    <div className="tech-left">
                        <div className="project-title">Projects</div>
                    </div>
                    <div className="row project-row">
                        <a className="card" data-toggle="modal" data-target=".planner">
                            <img src="./planner.png" alt="balloon with an emoji face" className="card__img">
                            </img>
                        ...
                        <a className="card" data-toggle="modal" data-target=".microblog">
                            <img src="./microblog.png" alt="balloon with an emoji face" className="card__img">
                            </img>
                            <span className="card__footer">
                                <span>Microblog</span>
                        ...
                        <a href="#" className="card">
                            <img src="https://images.unsplash.com/photo-1526297003708-f5a1c2c9c6e7?crop=entropy&cs=tinysrgb&fm=jpg&ixid=MnwzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2NjI0OTY1ODM&ixlib=rb-1.2.1&q=80" alt="balloon with an emoji face" className="card__img">
                            </img>
                            <span className="card__footer">
            ...
            <div id="footer" className="header wrap">
                <div className="footer-container">
                    <div className="footer-left">
                        ...
                        <div className="footer-icons">
                            <div className="footer-card">
                                <div className="icons">
                                    <a className="footer-a" href="mailto:erikafuerte09@gmail.com">
                                        <i className="bi bi-envelope-at-fill"></i>
                                    </a>
                                </div>
                            </div>
                            <div className="footer-card">
                                <a className="footer-a" href="https://www.linkedin.com/in/erika-fuerte-1182aa222/"><i className="bi bi-linkedin"></i></a>
                            </div>
                            <div className="footer-card">
                                <div className="icons">
                                    <a className="footer-a" href="tel:+639206509163">
                    ...
                    <div className="footer-right">
                        <div className="copyright">Copyright ©2024 Erika Fuerte</div>
                    </div>
                </div>
            </div>

            <div className="modal fade planner" tabIndex={-1} role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div className="modal-dialog modal-lg">
                    <div className="modal-content project-modal">
                        <div className="project-modal__left">
                            <div className='modal-project-title'>Planner</div>
                            <div >
                                <img className='project-img' src="./planner.gif" alt="" />
                            </div>
                            <div>
                                A Monthly Planner with an organized layout includes distinct sections for Daily Tasks, Weekly Tasks, Monthly Tasks, Goals, Notes, and a Calendar View.
                            </div>
                        </div>
                        <div className='vertical'></div>
                        <div className="project-modal__right">
                            <div>
                                <div className='modal-project-subtitle'>Development Type</div>
                                <div>Web Application</div>
                            </div>
                            <div>
                                <div className='modal-project-subtitle'>Duration</div>
                                <div>3 Weeks</div>
                            </div>
                            <div>
                                <div className='modal-project-subtitle'>Technology Development Language</div>
                                <div><a href="https://github.com/Hakdoff/todo-react.tsx">React</a></div>
                                <div><a href="https://github.com/Hakdoff/Todo-C-.git">C#</a></div>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div className="modal fade microblog" tabIndex={-1} role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div className="modal-dialog modal-lg">
                    <div className="modal-content project-modal">
                        <div className="project-modal__left">
                            <div className='modal-project-title'>Planner</div>
                            <div >
                                <img className='project-img' src="./microblog.gif" alt="" />
                            </div>
                            <div>
                                A community where you can freely share your thoughts. It includes sections for posting, liking, sharing, following and searching of users.
                            </div>
                        </div>
                        <div className='vertical'></div>
                        <div className="project-modal__right">
                            ...
                            <div>
                                <div className='modal-project-subtitle'>Technology Development Language</div>
                                <div><a href="https://github.com/Hakdoff/laravel---microblog">Laravel - Tailwind</a></div>
                            </div>
                        </div>
                    </div>
                </div>
